...
const STORE = {
  questions: [
    ...
    {
      question:
        "Your doctor diagnoses you with Bromodosis after a recent doctor's visit, what do you have?",
      answers: [
        "Food poisoning",
        "A caffeine high",
        "Stinky feet",
    ...
    {
      question:
        "The “recovery position” is the recommended posture for which of the following?",
      answers: [
    ...
    {
      question:
        "*Bonus Question*: Any guess on what Brassica oleracea is? (You may be surpised of the answer)",
      answers: [
